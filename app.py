...
with tab2:
    ...
    div[data-testid="stButton"] button[kind="secondary"] {
        visibility: hidden; height: 0 !important; padding: 0 !important; margin: 0 !important; min-height: 0 !important;
    }
    </style>
    """, unsafe_allow_html=True)
    ...
    for col, opt in zip([m1,m2,m3,m4], meal_options):
        ...
        col.markdown(
            ...
            f"font-weight:{fw};font-size:14px;cursor:pointer;'>{opt}</div>",
            unsafe_allow_html=True
        )
